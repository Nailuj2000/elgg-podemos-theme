...
/* ***************************************
	Panel de Widgets del perfil
*************************************** */

div.elgg-widgets-add-panel#widgets-add-panel {
padding: 10px;
margin: 0 5px 15px;
background: #fff;
...
.elgg-menu-page a {
	...
	background: #269283 url(<?php echo elgg_get_site_url(); ?>mod/bright-theme/graphics/button.png) repeat-x left top;
  border: 0px solid #97c2b8;
	padding: 5px 15px;
	margin: 6px 0;
	color:#fff;
}
